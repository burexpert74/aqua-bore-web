...
const galleryImages = [
  {
    ...
    details: {
      ...
      reach: "до 8 метров",
      capacity: "до 3 тонн",
      description: "Мобильная буровая установка на базе ISUZU, оснащённая буровой установкой Aichi D502. Предназначена для бурения отверстий диаметром от 100 до 800 мм на глубину до 8 метров. Идеально подходит для установки опор ЛЭП, свайных фундаментов, бурения под заборы и другие земляные работы."
    }
  }
