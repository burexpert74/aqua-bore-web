      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 py-6 sm:py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 max-w-md text-base md:text-base leading-relaxed">
              Собственный автопарк, индивидуальный подход.
            </p>
            <div className="bg-gray-800 p-3 md:p-4 rounded-lg">
              <p className="text-base md:text-base font-medium text-blue-400 mb-1">
          ...
          <div>
            ...
            <div className="space-y-2 md:space-y-3 text-base md:text-base">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button 
                  ...
                  className="break-all text-sm sm:text-base md:text-base hover:text-blue-400 transition-colors"
                >
                  Andron_v_k@mail.ru
                </button>
              </div>
              ...
              <div className="bg-blue-900/30 p-3 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-semibold text-base">Ежедневно: 06:00-23:00</div>
                    <div className="text-sm text-gray-400">Принимаем заявки круглосуточно</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3 text-gray-300 text-base md:text-base">
              <li>
                <button 
